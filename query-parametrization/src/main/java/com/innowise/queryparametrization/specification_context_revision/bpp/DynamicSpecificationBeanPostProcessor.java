package com.innowise.queryparametrization.specification_context_revision.bpp;
    ...
    private static class DynamicSpecificationInvocationHandler implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            if (method.isAnnotationPresent(WithDynamicSpecification.class)) {
                SpecificationContext<?> specHolder = context.getBean(SpecificationContext.class);
